...
# 1️⃣ Bot tokenni shu yerga yozing
TOKEN = "7988887798:AAFiueH2VGGtkpdHn-r1OWuHckYL83PvwyU"
bot = Bot(token=TOKEN)
dp = Dispatcher()
...
async def inline_handler(query: InlineQuery):
    ...
    all_voices = [
        ...
        {"id": "17", "title": "Qachan bizam uylanamiz", "file_id": "AwACAgQAAxkBAANLaZIzfgVz8mUiZ2RUvwmBaoSApOcAArcdAAIx9pFQFedTKtf3IKo6BA"},
        {"id": "18", "title": "Arda guler...", "file_id": "AwACAgQAAxkBAANNaZIzhXFLJrJvL3YfkgKz_4VtZZAAArgdAAIx9pFQPLsHuBFhSPs6BA"},
        {"id": "19", "title": "Turinglar ee soat 8:30 bolyapti", "file_id": "AwACAgQAAxkBAANPaZIzoA5GRjLOqY3oL6DY3U9ESzEAArkdAAIx9pFQT1Z_OqjVU1A6BA"},
        {"id": "20", "title": "Assalomu allaykum, Nima gapla", "file_id": "AwACAgQAAxkBAANRaZIzp-MR9ytHJPKZHAAB83H0b_oYAAK6HQACMfaRUCvcvOXPEAABsjoE"},
        {"id": "21", "title": "Assalomu allaykum, Jaydari jigitlar", "file_id": "AwACAgQAAxkBAANTaZIzr7S_vxjXA8SprRfWJxtpgEsAArsdAAIx9pFQCniHM4N4A_w6BA"},
        {"id": "22", "title": "Assalomu allaykum Juma ayyom", "file_id": "AwACAgQAAxkBAANVaZIztrfYV7XQ6hbeH3lkInuYn_sAArwdAAIx9pFQK4VMQxvgEAo6BA"}
    ]
